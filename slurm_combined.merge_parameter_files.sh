...
# merge traces
# sbatch --dependency=afterok:$jobid_sanity --mail-user=$user@pik-potsdam.de --job-name=attrici_merge_traces_${tile}_${var} --output=${logfile} --error=${logfile} merge_parameter_files.sh ${tile} ${var}
sbatch --mail-user=$user@pik-potsdam.de --job-name=attrici_merge_traces_${tile}_${var} --output=${logfile} --error=${logfile} merge_parameter_files.sh ${tile} ${var}
